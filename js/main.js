	...
	bindEvent: function(){
        ...
        $('.pf-logout a').on('click', function() {
         ...
         $('#mm-tabrefresh').click(function(){
            var currentTab = $('.easyui-tabs1:visible').tabs('getSelected');
            var url = currentTab.find("iframe").attr("src");
        ...
        //     $('#pf-page').find('iframe').eq(0).attr('src', 'http://www.uimaker.com/easyui/01/pages/static/green/js/backend/modify_pwd.html')
        // });

        // $(document).on('click', '.pf-notice-item', function() {
        //     $('#pf-page').find('iframe').eq(0).attr('src', 'http://www.uimaker.com/easyui/01/pages/static/green/js/backend/notice.html')
        // });
	},
